...
def create_tables(database):
    ...
    create_table(database, "FormulasComments", 'CREATE TABLE "FormulasComments"("FormulaId" INTEGER PRIMARY KEY, "Site" TEXT, "CommentId" INTEGER, "LaTeXBody" TEXT, "SLTBody" TEXT, "TokenLength" INTEGER, "StartingPosition" INTEGER, "Inline" BOOLEAN)')
    create_table(database, "FormulasPosts", 'CREATE TABLE "FormulasPosts"("FormulaId" INTEGER PRIMARY KEY, "Site" TEXT, "PostId" INTEGER, "LaTeXBody" TEXT, "SLTBody" TEXT, "TokenLength" INTEGER, "StartingPosition" INTEGER, "Inline" BOOLEAN)')
