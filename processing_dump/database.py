...
def create_tables(database):
    ...
    create_table(database, "FormulasComments", 'CREATE TABLE "FormulasComments"("FormulaId" INTEGER PRIMARY KEY, "CommentId" INTEGER, "Body" TEXT, "TokenLength" INTEGER, "StartingPosition" INTEGER)')
    create_table(database, "FormulasPosts", 'CREATE TABLE "FormulasPosts"("FormulaId" INTEGER PRIMARY KEY, "PostId" INTEGER, "Body" TEXT, "TokenLength" INTEGER, "StartingPosition" INTEGER)')
